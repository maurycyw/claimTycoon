...
[CustomEditor(typeof(ALPController))]
[CanEditMultipleObjects]
public class ALP_ControllerGlobalEditor : Editor
{
    #region [Properties ALP]

    private ALPController controller;
    ...
    #endregion [Properties ALP]

    #region [Unity Actions]

    private void OnEnable()
    {
        controller = (target as ALPController);
    ...
    [MenuItem("Window/ALP/Controller/Add Controller...", priority = 311)]
    public static void CreateGlobalALPWindController()
    {
        GameObject WindController = new GameObject("ALP Controller");
        var egc = WindController.AddComponent<ALPController>();
    ...
    [MenuItem("GameObject/3D Object/ALP/Add Global Controller...", priority = 9999)]
    public static void CreateGlobalALPWindControllerGameObject()
    {
